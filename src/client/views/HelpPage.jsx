    ...
    return (
      <div id='helpPage' className='pure-u-1 d-flex flex-column flex-v-center pages'>
        <div className='box shadow pure-u-1 pure-u-sm-1 pure-u-md-22-24 pure-u-lg-15-24 pure-xl-15-24'>
          ...
          <p>{t('You need to choose a symbol, or ticker, for your token. For example, Ethereum is identified with the ETH ticker, Bitcoin with BTC, Euro with EUR, Dollar with USD. Find a ticker that has a connection with your name. The ticker must be all capital letters and can have 3 or 4 characters only. Choose wisely in order to avoid collision. Check on ')}<a href='https://coinmarketcap.com/' target='_blank'>Coinmarketcap</a>{t(' or other websites if a ticker is already taken and choose one that is not used by anyone.')}</p>
